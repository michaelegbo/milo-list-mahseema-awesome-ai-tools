...
- [Milo](https://milo.seemplifyai.com/) - Browser voice chatbot with an animated 3D robot, local transcription, and local or optional ChatGPT replies; free for personal, noncommercial use.
